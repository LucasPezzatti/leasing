...
?>
 ...
 <?php 
 $localsql=new localsql();
 $buscadesp = $localsql->busca_despesas_date_tela_saida($dtini,$dtfin,$pdom); //BUSCA DESPESAS (Exceto BAIXAS)
...
?>
	...
	<div class="row">
	 <div class="col-12 col-lg-12">
	   <div class="card">
	     <div class="card-header">Financeiro - Despesas/Saídas
		 </div>
     <div class="card-action">
       <span class="float-right">
        <br>
        <form class="form form-inline" method="POST" action="global_date_pr.php?origin=despesas">
       <a href="mvm_despesa.php?action=new&key=<?php echo md5(gethostbyaddr($_SERVER['REMOTE_ADDR']));?>"> <button class="btn btn-danger" type="button" style="margin-right:8px" >Novo Lançamento </button> </a>
