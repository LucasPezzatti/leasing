...
?>
    ...
    <div class="card-content">
        ...
        <?php 
            ...
            ?>
          <div class="col-12 col-lg-3 col-xl-2 border-light">
                <div class="card-body">
            ...
            <div class="col-12 col-lg-6 col-xl-4 border-light">
                <div class="card-body">
                  <h5 class="text-white shadow_dark mb-0"><?php if($screen_mode=="low"){echo"<br><br>";}?> <span class="float-center"><?php echo $showperiodo;?>  <i class="zmdi zmdi-calendar"></i></span></h5>
                  <?php if($screen_mode=="low"){echo"<br>";}?>
                  <div class="progress my-3 b_shadow_dark" style="height:4px;width:260px;">
                       <div class="progress-bar" style="width:260px;background-color:#fff"></div>
                    </div>
                  <p class="mb-0 text-white small-font"> <span class="float-left">
                  </span>
                </div>
