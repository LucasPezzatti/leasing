...
$action=$_GET['action'];
if($action=='new'){
$cardtitle="Nova Receita/Entrada";
$buttonsubmit="Incluir";
}
elseif($action=='edt'){
$cardtitle="Editar Receita/Entrada";
    ...
    <div class="row mt-3">
      <div class="col-lg-5"  style="margin:auto;">
         <div class="card">
           ...
           <hr>
           <form autocomplete="off" id="" method="POST" action="mvm_receita_pr.php?key=<?php echo md5(gethostbyaddr($_SERVER['REMOTE_ADDR']))."&action=".$action;?>">
